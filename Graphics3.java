...
public class Graphics3 extends Canvas
{
    public void paint( Graphics g )
    {
        ...
        g.setFont(new Font("Algerian", Font.BOLD+Font.ITALIC, 60)); // 60-pt italic bold
        g.drawString("Leander Lions", 300, 350);

        g.setColor(Color.blue);
        g.setFont(Font.decode("Algerian-BOLDITALIC-60")); // a different way to specify the same font
    ...
    {
        JFrame win = new JFrame("Graphics3: Fonts and Lines");
        win.setSize(800,600);
